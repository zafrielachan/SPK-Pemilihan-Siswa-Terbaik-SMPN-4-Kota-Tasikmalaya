...
<div class="container">
    <div class="row">
            ...
            <div class="box-header">
                <h3 class="box-title mt-1 mb-1">Nilai Preferensi</h3>
                <p>
                    <a style="margin-bottom:10px" href="cetak.php" target="_blank" class="btn btn-primary float-end"><span class='glyphicon glyphicon-print'></span>Cetak Laporan</a>
                </p>
            </div>
                ...
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th><center>Nilai Preferensi (V<sub>i</sub>)</center></th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
